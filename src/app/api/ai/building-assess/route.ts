...
export async function POST(request: Request) {
  try {
    ...
    return NextResponse.json(
      {
        ...
        buildingRisk: snapshot.buildingRisk,
        evacuationPlan: snapshot.evacuationPlan,
        multiAgentConsensus: snapshot.multiAgentConsensus,
      },
    ...
    return NextResponse.json(
      {
        error: "Unable to run building assessment",
